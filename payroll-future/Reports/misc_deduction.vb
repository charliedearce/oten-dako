...
Public Class misc_deduction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "payroll_future.misc_deduction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmisc_deduction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As misc_deduction = New misc_deduction()
        rpt.Site = Me.Site
        Return rpt
    End Function
