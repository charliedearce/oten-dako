...
Public Class htaxDeduction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "payroll_future.htaxDeduction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedhtaxDeduction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As htaxDeduction = New htaxDeduction()
        rpt.Site = Me.Site
        Return rpt
    End Function
