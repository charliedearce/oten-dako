...
Public Class pagibigDeduction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "payroll_future.pagibigDeduction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpagibigDeduction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As pagibigDeduction = New pagibigDeduction()
        rpt.Site = Me.Site
        Return rpt
    End Function
